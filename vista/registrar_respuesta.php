...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Estudiante/Monitor | Respuestas</title>
    ...
    <body class="skin-blue">
	 ...
	 <div id="ver_pregunta_rep" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <div id="modalContent_pregunta_rep" style="display:none;">
                      ...
                      <section class="col-lg-12 connectedSortable"> 
							...
							$respuesta_l=new controla_clase_respuesta();
							$respuesta_l->val_clase_respuesta_listado($_SESSION["codigo"]);
							?>
...
{   
    ...
    $.ajax({
        cache: false,
        type: 'POST',
        url: '../vista/ver_pregunta_respuesta.php',
        data: 'id_pregunta='+essay_id,
        success: function(data) 
        {
            $('#ver_pregunta_rep').show();
            $('#modalContent_pregunta_rep').show().html(data);
        }
    });
});
</script>  
